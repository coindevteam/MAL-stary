...
const string strMessageMagic = "MalibuCoin Signed Message:\n";
...
int64_t GetProofOfWorkReward(int64_t nFees)
{
    int64_t nSubsidy = 0 * COIN;
			...
			else if(pindexBest->nHeight < 20)
		{
			...
			else if(pindexBest->nHeight < 40320)
		{
			nSubsidy = 35 * COIN;
		}
			else if(pindexBest->nHeight < 262080)
		{
			nSubsidy = 15 * COIN;
		}
...
bool CheckDiskSpace(uint64_t nAdditionalBytes)
{
    ...
    if (nFreeBytesAvailable < nMinDiskSpace + nAdditionalBytes)
    {
        ...
        printf("*** %s\n", strMessage.c_str());
        uiInterface.ThreadSafeMessageBox(strMessage, "MalibuCoin", CClientUIInterface::OK | CClientUIInterface::ICON_EXCLAMATION | CClientUIInterface::MODAL);
        StartShutdown();
        return false;
    }
    return true;
...
bool LoadBlockIndex(bool fAllowNew)
{
    ...
    if (mapBlockIndex.empty())
    {
        ...
        const char* pszTimestamp = "01.10.2014 MalibuCoin";
        CTransaction txNew;
        txNew.nTime = 1413201690;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        ...
        //// debug print
        assert(block.hashMerkleRoot == uint256("0x646847f6531116876a2bd92e105f221f3692fc90e74dce7127fd25bdf162a7ed"));
        block.print();
...
unsigned char pchMessageStart[4] = { 0xa3, 0xb0, 0xf2, 0xe3 };
